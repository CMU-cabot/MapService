...
<script type="text/javascript" src="js/linkcover.js?<%=T%>"></script>
		...
		<div role="main" class="ui-content" style="padding: 0">
			...
			<table>
				<tbody>
					...
					<tr class="basic_menu" style="display: none">
					...
					<tr class="basic_menu">
						<td><label for="attempts">attempts</label></td>
						<td><input data-mini="true" id="attempts" name="attempts" type="number" min="1" step="1" value="1000" /></td>
					</tr>
					<tr class="basic_menu">
						<td colspan="2">
